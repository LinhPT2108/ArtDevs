...
//		model.addAttribute("flashSales",vouch);
		...
		Double pricevoucher = voucher.getDiscount();
	...
	public String updatevoucher(@ModelAttribute("vouchers") Voucher voucher, BindingResult bd, Model model) {
...
//		model.addAttribute("flashSales",vouch);
	...
	public String deleteflashSale(@PathVariable("id") Integer id,Model model) {
		vouDAO.deleteById(id);
		return "redirect:/admin/voucher";
	}
}
